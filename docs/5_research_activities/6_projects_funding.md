...
| **Personal Contingency Funds (PCF)** | 35% of institute overheads from every externally sponsored project is added to PCF Further, consultancy and other earnings can also be deposited in PCF <sup>†</sup> | Same as CPDA | Apply through workflow. <br><br> Advance will be provided only for International Travel. <br><br> Procurement of laptops/ desktops/ tablets/ mobile phones/ printers/ stationeries, etc. allowed under PCF. | PCF accumulates throughout the faculty’s career.  |
