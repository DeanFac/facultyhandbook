...
| **New Faculty Seed Grant (NFSG)** | **Up to ₹ {{ site.data.variables.nfsg }} lakhs (Duration- 3 years)** | This is not an entitlement — only a partial amount may be awarded. | A proposal with proper justification has to be submitted and presented in front of a committee. | Within 3 years of joining. (Typically, after 1.5-2 years) |
| **Exploratory Research Projects**  | **Up to ₹ {{ site.data.variables.erp }} lakhs (Duration 1 year)** | Developing proof of concept before applying for a larger external funding. | A proposal with proper justification has to be submitted <u>against a call.</u> | Throughout career |
| **Socially Relevant Project** | **Up to ₹ {{ site.data.variables.soc_rel }} lakhs (Duration 1 year)** |  | A proposal with proper justification has to be submitted <u>against a call.</u> | Throughout career |

# Funding Sources Available for Professional Development

| Grant | Amount                                                                                                                                                                 | Purpose | Process | Timeline |
| :---- |:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------| :---- | :---- | :---- |
| **Cumulative Professional Development Allowance (CPDA)** | Rs. {{ site.data.variables.cpda }} lakhs for a block period of {{ site.data.variables.cpdablock }} years  (on a reimbursable basis)                                                                                               | • Conference travels <br> • Membership for Professional Societies <br> • Equipment, components and maintenance <br> • Books, Journals, Patent, Monograms, Chemicals, Data purchase, Testing Charges, Professional development courses, Software, Cloud space <br> • Field visit / collection of samples <br> • Publication charges for approved open access journals | Apply through workflow. <br><br> Advance will be provided only for International Travel. <br><br> Procurement of laptops/ desktops/ tablets/ mobile phones/ printers/ stationeries, etc. **NOT** allowed under CPDA. | Unutilized CPDA amount of one block will be carried forward to the next block. |
| **Personal Contingency Funds (PCF)** | {{ site.data.variables.pcf }}% of institute overheads from every externally sponsored project is added to PCF. Further, consultancy and other earnings can also be deposited in PCF <sup>†</sup> | Same as CPDA | Apply through workflow. <br><br> Advance will be provided only for International Travel. <br><br> Procurement of laptops/ desktops/ tablets/ mobile phones/ printers/ stationeries, etc. allowed under PCF. | PCF accumulates throughout the faculty’s career.  |
| **High Risk High Reward Mobility Grant** |s                                                                                                                                                                        | Strengthen ties with top-ranked institutions (e.g., QS top 25\) and improve perception/ visibility. <br><br> Achieve tangible outcomes: publications, innovative solutions, and new academic resources  | [https://ge.iitm.ac.in/programs/faculty-mobility/hrhrg](https://ge.iitm.ac.in/programs/faculty-mobility/hrhrg)  | Research Stays: <br> Faculty: 2-3 months.<br> Ph.D. students: 6-12 months. |
