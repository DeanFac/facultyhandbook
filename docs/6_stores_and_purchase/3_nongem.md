...
**For non-local purchase (less than 20% of local content), technical justification required**
 ...
 - C. Above ₹ {{ site.data.variables.tender }} lakh:  Exclusive Purchase Committee (EPC) **has to be** formed with approval from Director before purchase process can be initiated. The committee meets on the following points:
	...
	- (ii)	After tender deadline, the committee members have to sign on all the envelopes. First, **<u>only technical bids</u>** are opened in presence of the committee. After opening, the committee will sign on all the technical bids. 
	...
	- (v)	Once the financial bids are opened, order shall be placed **<u>only</u>** with the lowest bidder (L1) among the opened financial bids.
