...
function initSearch() {
  ...
  request.open('GET', '/n.swaminathan/fachandbook/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/n.swaminathan/fachandbook/assets/css/just-the-docs-' + theme + '.css');
}
